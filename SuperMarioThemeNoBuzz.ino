...
void playMarioTheme() {
  int melody[] = {
    ...
    NOTE_D7, NOTE_B6, 0, 0, NOTE_C7, 0, 0,
    NOTE_G6, 0, 0, NOTE_E6, 0, 0, NOTE_A6, 0,
    NOTE_B6, 0, NOTE_AS6, NOTE_A6, 0,
    NOTE_G6, NOTE_E7, NOTE_G7,
    NOTE_A7, 0, NOTE_F7, NOTE_G7, 0, NOTE_E7, 0, NOTE_C7,
    NOTE_D7, NOTE_B6, 0, 0, NOTE_C7, 0, 0
  };
  ...
  for (int i = 0; i < sizeof(melody) / sizeof(melody[0]); i++) {
    if (melody[i] == 0) {
      ...
      tone(BUZZ, melody[i], noteDurations[i] * 30);
      delay(noteDurations[i] * 30);
    }
    delay(10); // Pausa entre as notas
  }

  noTone(BUZZ); // Garante que o buzzer está desligado no final
}
